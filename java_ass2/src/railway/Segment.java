 ...
 * 7 meters from (j1, FACING). It contains 5 locations, and is 4 meters long.
 * 
...
public class Segment {
    ...
    public Location getLastLocation() {
        if (endOffset == section.getLength()) {
            ...
            return new Location(section,
                    section.otherEndPoint(departingEndPoint), 0);
        } else {
            // endOffset < section.getLength()
    ...
    public boolean contains(Location location) {
        if (location.atAJunction()) {
             ...
             */
            return (location.equals(this.getFirstLocation())
                    || location.equals(this.getLastLocation()));
        } else {
            /*
    ...
    public String toString() {
        return startOffset + " meters from " + departingEndPoint + " to "
                + endOffset + " meters from " + departingEndPoint;
    }
